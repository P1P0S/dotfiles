...
-- lvim.builtin.lualine.style = "lvim" --default or none
-- lvim.builtin.lualine.options.theme = "gruvbox"

-- personal plugin staline.nvim
vim.cmd("source ~/.config/lvim/user/staline.lua")
vim.cmd("source ~/.config/lvim/user/stabline.lua")
...
vim.cmd("source ~/.config/lvim/user/blankline.lua")
vim.cmd("source ~/.config/lvim/user/colorizer.lua")
