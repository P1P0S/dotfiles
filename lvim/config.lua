...
-- lvim.builtin.lualine.style = "default" --default or none
...
lvim.keys.normal_mode["<M-Left>"] = ":tabprevious<cr>"
lvim.keys.normal_mode["<M-Right>"] = ":tabnext<cr>"
...
lvim.plugins = {
	...
	-- cmd = "vim.g.tokyonight_style = 'night'",
	--}
